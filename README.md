...
- 2026-08-15: HTTP 200 capacity-shed failures now use the same semantic 503 status as direct upstream overload responses after failover is exhausted; ordinary structured server errors remain 502.
