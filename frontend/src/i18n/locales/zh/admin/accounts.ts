export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '保持账号设备标识稳定。session/full 转发按 API Key 和对话隔离会话、线程，不合并不同用户的对话；缺少对话标识时仅在当前请求或 WS 连接内复用。默认跟随系统。',
        codexFingerprintInherit: '跟随系统默认',
        codexFingerprintOff: '关闭收敛（保留账号隔离）',
        ...
        quotaBypassDesc: '开启后，该账号的每个 Codex 请求都会注入一组超额工具调用；上游错误仍按常规请求处理。',
