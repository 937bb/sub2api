  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_RECHARGE_TOO_LOW: '累计有效充值未达到管理员设置的最低金额。有效充值包含在线支付净额、余额兑换码和管理员手动充值净额。',
        GROWTH_RECENT_SPEND_TOO_LOW: '在管理员设置的近期消费窗口内，实际消费未达到最低金额。',
        GROWTH_IDENTITY_RISK: '当前网络或设备触发了签到风控，请联系管理员核查。',
        GROWTH_CHECKIN_REWARD_CAP: '累计签到奖励已达到有效充值金额对应的上限。',
        GROWTH_TOTAL_REWARD_CAP: '累计增长奖励已达到有效充值金额对应的总上限。',
    ...
    admin: {
      ...
      rewardAmount: '奖励金额',
      antiAbuse: '奖励资格与反作弊',
      antiAbuseDescription: '只有满足账号年龄和真实消费要求的账号可领奖；IP 和设备仅保存不可逆 HMAC 摘要。',
      accountAge: '最小账号年龄（天）',
      totalRecharged: '最低累计有效充值',
      rewardPaidRatio: '签到累计奖励上限比例',
      rewardPaidRatioHint: '签到累计奖励不能超过有效充值金额 × 此比例；有效充值包含在线支付净额、余额兑换码和管理员手动充值净额。',
      totalRewardPaidRatio: '全部增长奖励上限比例',
      totalRewardPaidRatioHint: '签到、排行等奖励总额不能超过有效充值金额 × 此比例。',
      recentSpend: '最低近期消费',
      spendWindow: '消费统计窗口（天）',
      ipLimit: '同 IP 每日账号上限',
