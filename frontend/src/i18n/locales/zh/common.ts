  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_RECHARGE_TOO_LOW: '累计真实充值未达到管理员设置的最低金额。余额和赠送额度不计入真实充值。',
        GROWTH_RECENT_SPEND_TOO_LOW: '在管理员设置的近期消费窗口内，实际消费未达到最低金额。',
        GROWTH_IDENTITY_RISK: '当前网络或设备触发了签到风控，请联系管理员核查。',
        GROWTH_CHECKIN_REWARD_CAP: '累计签到奖励已达到真实实付金额对应的上限。',
        GROWTH_TOTAL_REWARD_CAP: '累计增长奖励已达到真实实付金额对应的总上限。',
    ...
    admin: {
      ...
      accountAge: '最小账号年龄（天）',
      totalRecharged: '最低累计真实充值',
      rewardPaidRatio: '签到累计奖励上限比例',
      rewardPaidRatioHint: '签到累计奖励不能超过真实实付金额 × 此比例；例如 0.2 表示最多 20%。',
      totalRewardPaidRatio: '全部增长奖励上限比例',
      totalRewardPaidRatioHint: '签到、排行等奖励总额不能超过真实实付金额 × 此比例。',
      recentSpend: '最低近期消费',
