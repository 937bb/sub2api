export default {
  ...
  balanceEntries: {
    title: '余额明细',
    description: '查看您的余额变动记录和余额构成',
    summary: {
      totalBalance: '总可用余额',
      permanentBalance: '永久余额',
      expirableBalance: '有效期余额',
      expiringSoon: '即将过期',
      withinDays: '{days} 天内',
    },
    table: {
  ...
  admin: {
    ...
    users: {
      ...
      createdAt: '创建时间',
      totalRecharged: '总充值',
      tabRedeemHistory: '兑换/充值记录',
      tabBalanceEntries: '余额明细（含奖励）',
      noBalanceEntries: '暂无余额明细',
      entryPermanent: '永久',
      entryExpirable: '有效期',
      entryExpired: '已过期',
      entryRemaining: '剩余',
      ...
      sourceRedeem: '兑换码充值',
      sourceCheckin: '每日签到',
      sourceLeaderboard: '排行榜奖励',
      sourceAdmin: '管理员调整',
      sourcePromo: '优惠码赠送',
      sourceAffiliate: '邀请返利',
      sourceFirstRedeemBonus: '首次兑换加成',
      sourceRedeemBonus: '兑换加成',
      sourceCashback: '消费返现',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          redeemRebate: '兑换码充值返利',
          redeemRebateHint: '启用后，用户通过余额兑换码充值也会触发邀请返利（与支付充值返利共用比例和规则）。',
          customUsers: {
            title: '专属用户配置',
        ...
        firstRedeemBonus: {
          ...
          enabled: '启用首次兑换加成',
          enabledHint: '开启后，用户首次使用余额兑换码将获得额外加成。',
          multiplier: '加成倍率',
          multiplierHint: '倍率为 2 表示双倍（额外给 1 倍），充值 10 则加成 10。',
          cap: '加成上限',
          capHint: '加成金额上限，0 表示无上限。',
          balanceType: '加成余额类型',
          permanent: '永久余额',
          expirable: '有效期余额',
          expiryDays: '有效期天数',
          expiryDaysHint: '仅有效期余额生效。',
        },
        redeemBonus: {
          title: '常规兑换加成',
          description: '每次使用余额兑换码时额外发放加成奖励（含首次，可与首次加成叠加）。',
          enabled: '启用常规兑换加成',
          enabledHint: '开启后，每次余额兑换码充值均会触发加成。',
          mode: '加成模式',
          modeHint: '选择加成金额的计算方式。',
          modeFixed: '固定金额',
          modePercent: '按比例',
          modeRandom: '随机金额',
          fixedAmount: '固定金额',
          fixedAmountHint: '每次兑换固定加成的金额。',
          percent: '加成比例 (%)',
          percentHint: '按充值金额的百分比加成。',
          randomMin: '最小值',
          randomMax: '最大值',
          randomHint: '随机发放 min~max 之间的金额（支持两位小数，如 0.01~1.00）。',
          cap: '加成上限',
          capHint: '加成金额上限，0 表示无上限。',
          minAmount: '最低触发金额',
          minAmountHint: '充值金额低于此值不触发加成，0 表示无门槛。',
          balanceType: '加成余额类型',
          permanent: '永久余额',
          expirable: '有效期余额',
          expiryDays: '有效期天数',
        ...
        checkin: {
          title: '每日签到',
          description: '配置每日签到奖励的基础金额、随机范围和里程碑规则。',
          enabled: '启用签到',
          enabledHint: '开启后用户可以每日签到领取奖励。',
          mode: '奖励模式',
          modeHint: '选择基础奖励的计算方式。',
          modeFixed: '固定金额',
          modeRandom: '随机金额',
          fixedAmount: '固定金额',
          fixedAmountHint: '每次签到固定发放的金额。',
          randomMin: '最小值',
          randomMax: '最大值',
          randomHint: '每次签到随机发放 min~max 之间的金额（支持两位小数，如 0.01~1.00）。',
          balanceType: '奖励余额类型',
          balanceTypeHint: '签到基础奖励发放的余额类型。',
          permanent: '永久余额',
          expirable: '有效期余额',
          expiryDays: '有效期天数',
          expiryDaysHint: '有效期余额的有效天数（仅在余额类型为"有效期"时生效）。',
          milestones: '里程碑规则',
          milestonesHint: '连续签到满N天额外发放一次性奖励。',
          milestoneDays: '连续天数',
          milestoneAmount: '奖励金额',
          milestoneBalanceType: '余额类型',
          milestoneExpiryDays: '有效期(天)',
          addMilestone: '添加规则',
          removeMilestone: '删除',
        },
        balanceModel: {
          title: '余额模型',
          description: '配置余额过期、扣减优先级等高级余额管理功能。',
          expiryEnabled: '启用余额过期',
          expiryEnabledHint: '开启后，有效期余额到期将自动清零。关闭后所有余额永不过期。',
          warningDays: '过期预警天数',
          warningDaysHint: '用户端显示"即将过期"余额的预警天数（1-90）。',
          deductionOrder: '扣减优先级',
          deductionOrderHint: 'API 消费扣减余额时的优先顺序。',
          expiringFirst: '先扣有效期余额',
          permanentFirst: '先扣永久余额',
        },
        leaderboard: {
          title: '排行榜 + 奖励',
          description: '配置消费排行榜展示规则和自动发奖功能。',
          enabled: '启用排行榜',
          enabledHint: '开启后用户可查看消费排行榜，并自动发放每日奖励。',
          maskEmail: '用户名脱敏',
          maskEmailHint: '开启后排行榜仅显示部分邮箱，保护用户隐私。',
          topN: '展示 Top N',
          topNHint: '排行榜展示的前 N 名用户数量。',
          rewardRules: '奖励规则',
          rewardRulesHint: '按名次配置奖励，支持固定金额或昨日消费百分比。',
          addRule: '添加规则',
          ruleRank: '名次',
          ruleMode: '模式',
          ruleAmount: '金额/百分比',
          ruleBalanceType: '余额类型',
          ruleExpiryDays: '有效期天数',
          modeFixed: '固定金额',
          modePercent: '消费百分比',
          permanent: '永久',
          expirable: '有效期',
        ...
        cashback: {
          title: '消费返现',
          description: '用户消费满足门槛后自动返现到余额。',
          enabled: '启用消费返现',
          enabledHint: '开启后，满足消费门槛的用户将获得返现奖励。',
          threshold: '消费门槛',
          thresholdHint: '单次/每日消费金额达到此值才触发返现。',
          mode: '返现模式',
          modeHint: '选择返现金额的计算方式。',
          modeFixed: '固定金额',
          modePercent: '按比例',
          modeRandom: '随机金额',
          fixedAmount: '固定金额',
          fixedAmountHint: '每次返现的固定金额。',
          percent: '返现比例 (%)',
          percentHint: '按消费金额的百分比返现。',
          randomMin: '最小值',
          randomMax: '最大值',
          randomHint: '随机发放 min~max 之间的金额（支持两位小数，如 0.01~1.00）。',
          balanceType: '返现余额类型',
          ...
          expiryDaysHint: '仅有效期余额生效。',
          cycle: '结算周期',
          cycleHint: '选择返现结算的触发方式。',
          cycleRealtime: '实时（每次消费立即返现）',
          cycleDaily: '每日（次日凌晨统一结算）',
        },
        offPeakPricing: {
          title: '分时费率',
          description: '配置低峰时段费率折扣，类似新能源充电桩分时电价。',
          enabled: '启用分时费率',
          enabledHint: '开启后，命中时段规则的请求将按折扣倍率计费。',
          rules: '时段规则',
          rulesHint: '按时间段配置费率倍率。支持跨天时段（如22:00~07:00）。倍率小于1表示折扣，大于1表示加价。',
          addRule: '添加规则',
          startHour: '开始时间',
          endHour: '结束时间',
          multiplier: '费率倍率',
