    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          personalAccessTokenDesc: '输入 Codex Personal Access Token 和真实 ChatGPT Account ID，系统将按第一步配置创建 OpenAI OAuth-like 账号。',
          ...
          personalAccessTokenAccountIdPlaceholder: '粘贴真实 chatgpt_account_id...',
          personalAccessTokenAccountIdHint: '请输入真实 ChatGPT account/workspace ID；quota/reset 会作为 chatgpt-account-id 发送给上游。',
          personalAccessTokenImportAndCreate: '使用 PAT 创建账号',
          personalAccessTokenEmpty: '请输入 Personal Access Token',
          personalAccessTokenAccountIdEmpty: '请输入真实 ChatGPT Account ID',
