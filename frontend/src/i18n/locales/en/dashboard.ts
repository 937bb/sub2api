export default {
  ...
  keys: {
    ...
    openaiForcePriorityTier: 'Force OpenAI priority tier',
    openaiForcePriorityTierHint: 'Requests using this key send service_tier=priority. The administrator fast policy can still filter or block it.',
