export default {
    ...
    usage: {
      ...
      regularRequest: 'Regular',
      quotaBypassShort: 'Bypass ×{count}',
      quotaBypassApplied: 'Quota bypass applied ×{count}',
      quotaBypassStatus: 'Quota bypass',
      quotaBypassPairs: 'Injected pairs',
      routingDetail: 'Routing',
      usageDetail: 'Usage',
      clientDetail: 'Client',
      upstreamModel: 'Upstream model',
      sessionId: 'Session ID',
      failedToLoadDetail: 'Failed to load request details',
      retry: 'Retry',
