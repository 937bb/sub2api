export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        codexTicketEnabled: "Codex State acquisition",
      ...
      openAIOAuth429Dynamic: {
        title: 'OpenAI 429 Dynamic Scheduling',
        description: 'Sample Codex subscription 429 responses before pausing account scheduling',
        enabled: 'Enable dynamic 429 probing',
        enabledHint: 'Continue after isolated 429 responses and cool down only when the threshold is reached',
        windowSeconds: 'Sampling window (seconds)',
        minSamples: 'Minimum request samples',
          min429: 'Minimum 429 responses',
          ratioThreshold: '429 ratio threshold (0-1)',
          blockSeconds: 'Cooldown after trigger (seconds)',
          usageWindowCheck: 'Require exhausted usage window',
          usageWindowCheckHint: 'Only trigger cooldown when the reported 5-hour or 7-day usage reaches its configured threshold',
          usage5hThreshold: '5-hour usage threshold (%)',
          usage7dThreshold: '7-day usage threshold (%)',
          missingDataFallback: 'Missing usage fallback age (seconds)',
          planOverrides: 'Plan-specific policies',
          planOverridesHint: 'Exact plan_type matches override the default policy, including when the default policy is disabled',
          planType: 'Plan type',
          addOverride: 'Add policy',
          hint: 'Applies to OAuth, Plus/Team, PAT, and Setup Token accounts. API keys are unaffected.',
        saved: 'OpenAI 429 dynamic scheduling settings saved',
        saveFailed: 'Failed to save OpenAI 429 dynamic scheduling settings'
      },
      streamTimeout: {
