export default {
    ...
    subscriptions: {
      ...
      switchGroupHint: 'The term and accumulated usage are preserved when switching groups',
      ...
      guide: {
        ...
        actions: {
          ...
          switchGroup: 'Switch',
          switchGroupDesc: 'Move the subscription to another group while preserving term and usage',
          resetQuota: 'Reset Quota',
