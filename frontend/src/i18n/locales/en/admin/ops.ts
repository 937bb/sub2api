export default {
    ops: {
      ...
      turnState: {
        ...
        metrics: {
          oauthAccounts: 'Used in the last hour', readyAccounts: 'All models ready', missingAccounts: 'Incomplete accounts',
          readyModelSlots: 'Model States ready',
        ...
        scanSettings: {
          ...
          noRules: 'No separate rules; default target lengths apply.',
          addRule: '+ Add rule',
          deleteRule: 'Delete rule {index}',
          plan: 'Subscription plan',
          ruleLengths: 'Target lengths',
          invalidRuleModel: 'Select a valid plan and enter a model name of at most 200 characters with no spaces, or * for all models.',
          invalidRuleLengths: 'Each rule needs 1–16 unique integer lengths between 64 and 4096.',
          duplicateRule: 'Only one rule is allowed for each plan/model pair. Merge duplicate rules.',
          tooManyRules: 'Configure at most 128 plan/model rules.',
          planSwitches: 'Enable State scanning by plan',
          ...
          routeBinding: 'Bind State acquisition exit',
          routeBindingHint: 'When enabled, only State with an acquisition route ticket is ready. Business requests reuse the IPv6 or bound proxy that acquired State for that account/model. Legacy unbound State is scanned again.',
          routeBindingEnabled: 'Exit binding enabled: State, session, and acquisition exit are reused as one ticket.',
        ...
        targetLengths: 'Target {lengths}',
        scanAccount: 'Scan all target models for this account',
        readyProgress: '{ready}/{total} models ready',
        failedCount: '{count} failed',
        noTargetModels: 'No target model status',
        compact: { scanning: 'Scan', retry: 'Retry', failed: 'Failed', expiring: 'Expiring', missing: 'Missing' },
        ...
        deleteProxyFailed: 'Failed to delete proxy',
