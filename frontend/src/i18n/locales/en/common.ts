  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_IDENTITY_RISK: 'The current network or device triggered check-in risk control. Contact an administrator for review.',
    ...
    admin: {
      ...
      antiAbuseDescription: 'Rewards require account age and at least one actual usage charge in the configured activity window. IP and device signals are stored only as irreversible HMAC digests.',
