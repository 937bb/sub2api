export default {
  ...
  growth: {
    loadFailed: 'Failed to load growth incentive data',
    period: { daily: 'Daily', weekly: 'Weekly', monthly: 'Monthly' },
    checkin: {
      title: 'Daily Check-in',
      description: 'Review your calendar and claim daily credit',
      currentStreak: 'Current streak',
      totalDays: 'Total check-ins',
      todayReward: 'Today base reward',
      previousMonth: 'Previous month',
      nextMonth: 'Next month',
      actionTitle: 'Claim reward',
      disabled: 'Daily check-in is currently disabled.',
      doneDescription: 'Today is complete. Come back tomorrow.',
      readyDescription: 'Eligible accounts can claim today\'s reward.',
      claim: 'Check in now',
      completed: 'Checked in today',
      success: 'Check-in complete. You received ${amount}',
      failed: 'Check-in failed',
      errors: {
        GROWTH_CHECKIN_DISABLED: 'Daily check-in is currently disabled.',
        GROWTH_ALREADY_CHECKED_IN: 'You have already checked in today.',
        GROWTH_ACCOUNT_INACTIVE: 'This account cannot participate in daily check-in.',
        GROWTH_ACCOUNT_TOO_NEW: 'This account has not reached the configured minimum age.',
        GROWTH_RECENT_SPEND_TOO_LOW: 'No actual usage spend was found in the activity window configured by the administrator.',
        GROWTH_IDENTITY_RISK: 'This device or network has reached today\'s account limit for check-in rewards.',
        GROWTH_REWARD_INELIGIBLE: 'This account is not currently eligible for a check-in reward.',
      },
    ...
    admin: {
      ...
      description: 'Manage check-in rewards, leaderboard rewards, and abuse controls',
      configTab: 'Configuration',
      rewardsTab: 'Reward Ledger',
      riskTab: 'Risk Events',
      riskAccounts: 'Accounts for Review',
      riskEvents: 'Event Log',
      checkinSettings: 'Check-in Rewards',
      checkinSettingsDescription: 'Choose a fixed value or configure a min/max range randomized to cent precision.',
      rewardMode: 'Reward mode',
      fixed: 'Fixed value',
      random: 'Random range',
      fixedReward: 'Fixed value',
      minReward: 'Range minimum',
      maxReward: 'Range maximum',
      streakRewards: 'Streak Bonuses',
      streakRewardsDescription: 'Add a bonus when a configured consecutive-day milestone is reached.',
      days: 'Consecutive days',
      rewardAmount: 'Reward amount',
      antiAbuse: 'Eligibility and Abuse Controls',
      antiAbuseDescription: 'Rewards require account age and actual usage in the configured window. An IP limit rejects only that reward; device-limit hits on 3 distinct dates within 7 days escalate the account for review. Signals are stored only as irreversible HMAC digests.',
      accountAge: 'Minimum account age (days)',
      spendWindow: 'Usage activity window (days)',
      ipLimit: 'Daily accounts per IP',
      deviceLimit: 'Daily accounts per device',
      leaderboardSettings: 'Spending Leaderboard',
      leaderboardSettingsDescription: 'Enable the user-facing ranking and configure periodic awards.',
      anonymous: 'Anonymize other users',
      displayLimit: 'Leaderboard display count',
      displayLimitHint: 'The user leaderboard only returns the top N spenders, from 1 to 100.',
      rewardRules: 'Leaderboard reward rules',
      rewardRulesDescription: 'Each period starts with a first-place reward control. More rank ranges can be added. Completed periods settle once automatically.',
      periodRewards: '{period} rewards',
      addRankRange: 'Add rank range',
      enabled: 'Enabled',
      rankStart: 'Start rank',
      rankEnd: 'End rank',
      settlePrevious: 'Settle previous {period}',
      settleSuccess: 'Settlement complete: {count} users, ${amount}',
      settleFailed: 'Leaderboard settlement failed',
      saveFailed: 'Failed to save growth incentive configuration',
      user: 'User',
      source: 'Source',
      amount: 'Amount',
      ...
      status: 'Status',
      riskCount: 'Risk hits',
      lastRiskTime: 'Last flagged',
      adminAction: 'Admin action',
      actions: 'Actions',
      clearRisk: 'Clear risk',
      addWhitelist: 'Add to whitelist',
      removeWhitelist: 'Remove whitelist',
      actionNote: 'Action note',
      actionNotePlaceholder: 'Optional reason for this action',
      riskStatus: {
        flagged: 'Review Required',
        cleared_once: 'One-time clearance',
        whitelisted: 'Whitelisted',
      },
      riskReason: {
        ip_account_limit: 'Daily account limit reached for this IP',
        device_account_limit: 'Daily account limit reached for this device',
        missing_identity_signal: 'Network or device identity is missing',
      },
      riskAction: {
        clearTitle: 'Clear account risk',
        clearMessage: 'Allow {email} to bypass IP and device limits once. The clearance is consumed only after a successful check-in.',
        whitelistTitle: 'Add to risk whitelist',
        whitelistMessage: '{email} will continue to bypass IP and device check-in limits while whitelisted.',
        remove_whitelistTitle: 'Remove from risk whitelist',
        remove_whitelistMessage: '{email} will be checked against IP and device limits again.',
      },
      riskActionSuccess: 'Risk status updated',
      riskActionFailed: 'Failed to update risk status',
    },
  },

  timeBilling: {
    title: 'Time-based Billing',
    description: 'Manage daily or weekly recurring rate windows by group',
    repeatType: 'Recurrence',
    dailyRecurring: 'Daily',
    weeklyRecurring: 'Weekly',
    everyDay: 'Every day',
    nextDay: 'Next day',
    crossWeek: 'Cross-week',
    invalidDuration: 'Invalid time',
    ...
    allRuleStates: 'All rule states',
    enabledRules: 'Has enabled rules',
    disabledRules: 'All rules disabled',
    unconfigured: 'No rules configured',
    crossDayRules: 'Has overnight or cross-week rules',
    group: 'Group',
    platform: 'Platform',
    ...
    crossDay: 'Overnight',
    addRule: 'Add window',
    noRules: 'No time window is configured for this group',
    ruleCount: '{count} windows',
    overlapError: 'Enabled time windows overlap',
    ...
    invalidRule: 'The recurrence, weekday, or time is invalid, or the multiplier is negative',
  },
