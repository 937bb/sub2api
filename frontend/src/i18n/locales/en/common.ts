  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_RECHARGE_TOO_LOW: 'Lifetime real recharge is below the configured minimum. Balance and promotional credit do not count as real recharge.',
        ...
        GROWTH_CHECKIN_REWARD_CAP: 'Lifetime check-in rewards have reached the cap based on actual paid amount.',
        GROWTH_TOTAL_REWARD_CAP: 'Lifetime growth rewards have reached the total cap based on actual paid amount.',
    ...
    admin: {
      ...
      totalRecharged: 'Minimum lifetime recharge',
      rewardPaidRatio: 'Check-in lifetime reward cap ratio',
      rewardPaidRatioHint: 'Lifetime check-in rewards cannot exceed actual paid amount × this ratio; 0.2 means 20%.',
      totalRewardPaidRatio: 'All growth rewards cap ratio',
      totalRewardPaidRatioHint: 'All check-in and leaderboard rewards cannot exceed actual paid amount × this ratio.',
