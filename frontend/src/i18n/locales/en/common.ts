  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_RECHARGE_TOO_LOW: 'Eligible funding is below the configured minimum. It includes net online payments, redeemed balance codes, and net administrator top-ups.',
        GROWTH_RECENT_SPEND_TOO_LOW: 'Actual spend in the configured recent-spend window is below the minimum.',
        GROWTH_IDENTITY_RISK: 'The current network or device triggered check-in risk control. Contact an administrator for review.',
        GROWTH_CHECKIN_REWARD_CAP: 'Lifetime check-in rewards have reached the cap based on eligible funding.',
        GROWTH_TOTAL_REWARD_CAP: 'Lifetime growth rewards have reached the total cap based on eligible funding.',
    ...
    admin: {
      ...
      antiAbuseDescription: 'Rewards require account age and real spend. IP and device signals are stored only as irreversible HMAC digests.',
      accountAge: 'Minimum account age (days)',
      totalRecharged: 'Minimum eligible funding',
      rewardPaidRatio: 'Check-in lifetime reward cap ratio',
      rewardPaidRatioHint: 'Lifetime check-in rewards cannot exceed eligible funding × this ratio. Eligible funding includes net online payments, redeemed balance codes, and net administrator top-ups.',
      totalRewardPaidRatio: 'All growth rewards cap ratio',
      totalRewardPaidRatioHint: 'All check-in and leaderboard rewards cannot exceed eligible funding × this ratio.',
      recentSpend: 'Minimum recent spend',
      spendWindow: 'Spend window (days)',
