  ...
  growth: {
    ...
    checkin: {
      ...
      errors: {
        ...
        GROWTH_RECHARGE_TOO_LOW: 'Eligible funding is below the configured minimum. It includes net online payments and net administrator balance top-ups.',
    ...
    admin: {
      ...
      rewardPaidRatioHint: 'Lifetime check-in rewards cannot exceed eligible funding × this ratio. Eligible funding includes net online payments and net administrator top-ups.',
