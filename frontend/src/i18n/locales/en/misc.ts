export default {
  ...
  userSubscriptions: {
    ...
    advanceDailyQuota: 'Restore quota early',
    advanceDailyQuotaTitle: 'Restore daily quota early?',
    advanceDailyQuotaConfirm:
      'Review the quota and expiry details below. Confirming immediately deducts 24 hours of validity and cannot be undone.',
    advanceDailyQuotaBlocked: 'The requirements are not currently met. No subscription time will be deducted.',
    advancePreviewLoadingMessage: 'Checking the latest quota and expiry information.',
    loadingAdvancePreview: 'Loading restoration details…',
    advancePreviewFailed: 'Failed to load restoration details',
    advanceUnavailable: 'Early restoration is unavailable',
    dailyQuota: 'Full daily quota',
    naturalDailyReset: 'Natural restoration',
    weeklyRemaining: 'Weekly quota remaining',
    monthlyRemaining: 'Monthly quota remaining',
    recoverableQuota: 'Quota restored now',
    validityDeduction: 'Validity deducted',
    currentExpiry: 'Current expiry',
    expiryAfterAdvance: 'Expiry after deduction',
    hours: '{hours} hours',
    resetAtDetail: 'Restores in {time} ({date})',
    noResetBeforeExpiry: 'No further restoration before expiry',
    availableNow: 'Restoration time reached',
    periodUsagePreservedWarning: 'Weekly and monthly usage will not be cleared; only one complete daily quota is restored.',
    advanceBlockers: {
      subscription_inactive: 'The subscription is expired, suspended, or unavailable',
      one_time_subscription: 'A 24-hour pass provides one quota only and cannot be restored early',
      insufficient_term: 'Less than 24 hours of subscription validity remains',
      daily_quota_not_configured: 'This plan has no daily quota configured',
      daily_quota_already_reset: 'The daily quota has reached its natural restoration time, so no validity needs to be deducted',
      daily_quota_not_exhausted: 'The current daily quota has not been exhausted',
      weekly_quota_insufficient: 'The weekly remainder cannot cover one complete daily quota',
      monthly_quota_insufficient: 'The monthly remainder cannot cover one complete daily quota',
      unknown: 'The quota state changed. Refresh and try again'
    },
    advanceDailyQuotaSuccess: 'Daily quota restored and 24 hours deducted from the subscription',
    advanceDailyQuotaFailed: 'Failed to restore daily quota',
    advancingDailyQuota: 'Processing'
  },
