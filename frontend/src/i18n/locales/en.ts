export default {
  ...
  balanceEntries: {
    ...
    source: {
      ...
      cashback: 'Cashback',
      oauth_grant: 'First Bind Grant',
      consumption: 'API Consumption',
      expiry_clear: 'Expiry Cleanup',
      refund: 'Refund',
    },
    status: {
      active: 'Active',
  ...
  checkin: {
    ...
    quickSuccess: 'Check-in successful! Reward ${amount}',
  ...
  leaderboard: {
    ...
    description: 'View consumption rankings and rewards',
    ...
    rank: 'Rank',
    email: 'User',
    actualCost: 'Consumption',
    requests: 'Requests',
    tokens: 'Tokens',
    noData: 'No leaderboard data',
    unit: '$',
    rewardTitle: 'Leaderboard Rewards',
    rewardSettleHint: 'Settled daily based on yesterday rankings',
    rankLabel: 'Rank #{rank}',
    rewardFixed: 'Reward ${amount}',
    rewardPercent: 'Return {percent}% of yesterday consumption',
  ...
  admin: {
    ...
    settings: {
      ...
      firstRedeemBonus: {
        ...
        enabledHint: 'When enabled, first-time balance redeem will receive extra bonus.',
        multiplier: 'Bonus Multiplier',
        multiplierHint: 'Multiplier of 2 means double (extra 1x). Redeem 10 gets bonus 10.',
        cap: 'Bonus Cap',
        capHint: 'Max bonus amount. 0 = no cap.',
      ...
      redeemBonus: {
        ...
        description: 'Grant extra bonus on every balance code redemption (stacks with first redeem bonus).',
        enabled: 'Enable Regular Redeem Bonus',
        enabledHint: 'When enabled, every balance code redemption triggers bonus.',
        mode: 'Bonus Mode',
        ...
        fixedAmountHint: 'Fixed bonus per redemption.',
        percent: 'Bonus Percent (%)',
        percentHint: 'Bonus as percentage of redeemed amount.',
        randomMin: 'Min',
        randomMax: 'Max',
        randomHint: 'Random amount between min~max (supports 2 decimal places).',
        cap: 'Bonus Cap',
        capHint: 'Max bonus amount. 0 = no cap.',
        minAmount: 'Min Trigger Amount',
        minAmountHint: 'Redemptions below this amount will not trigger bonus. 0 = no minimum.',
        balanceType: 'Bonus Balance Type',
        permanent: 'Permanent',
        expirable: 'Expirable',
        expiryDays: 'Expiry Days',
      ...
      checkin: {
        title: 'Daily Check-in',
        description: 'Configure check-in reward amounts, random ranges, and milestone rules.',
        enabled: 'Enable Check-in',
        enabledHint: 'When enabled, users can check in daily for rewards.',
        mode: 'Reward Mode',
        modeHint: 'Choose how the base reward is calculated.',
        modeFixed: 'Fixed Amount',
        modeRandom: 'Random Amount',
        fixedAmount: 'Fixed Amount',
        fixedAmountHint: 'Fixed amount per check-in.',
        randomMin: 'Min',
        randomMax: 'Max',
        randomHint: 'Random amount between min~max per check-in.',
        balanceType: 'Reward Balance Type',
        balanceTypeHint: 'Balance type for check-in base reward.',
        permanent: 'Permanent',
        expirable: 'Expirable',
        expiryDays: 'Expiry Days',
        expiryDaysHint: 'Days until expiration (only for expirable balance).',
        milestones: 'Milestone Rules',
        milestonesHint: 'Extra one-time rewards for consecutive check-in streaks.',
        milestoneDays: 'Consecutive Days',
        milestoneAmount: 'Reward Amount',
      ...
      balanceModel: {
        title: 'Balance Model',
        description: 'Configure balance expiration, deduction priority, and advanced balance management.',
        expiryEnabled: 'Enable Balance Expiry',
        expiryEnabledHint: 'When enabled, expirable balance will be cleared on expiration.',
        warningDays: 'Expiry Warning Days',
        warningDaysHint: 'Days before expiry to show warning in user dashboard (1-90).',
        deductionOrder: 'Deduction Priority',
        deductionOrderHint: 'Priority order when deducting balance for API consumption.',
        expiringFirst: 'Expirable First',
        permanentFirst: 'Permanent First',
      },
      leaderboard: {
        title: 'Leaderboard + Rewards',
        description: 'Configure consumption leaderboard display and auto-reward rules.',
        enabled: 'Enable Leaderboard',
        enabledHint: 'When enabled, users can view consumption rankings with daily auto-rewards.',
        maskEmail: 'Mask Usernames',
        maskEmailHint: 'When enabled, only partial emails are shown for privacy.',
        topN: 'Show Top N',
        topNHint: 'Number of top users shown on the leaderboard.',
        rewardRules: 'Reward Rules',
        rewardRulesHint: 'Configure rewards by rank. Supports fixed amount or percentage of yesterday consumption.',
        addRule: 'Add Rule',
        ruleRank: 'Rank',
        ruleMode: 'Mode',
        ruleAmount: 'Amount/Percent',
        ruleBalanceType: 'Balance Type',
        ruleExpiryDays: 'Expiry Days',
        modeFixed: 'Fixed Amount',
        modePercent: 'Consumption %',
        permanent: 'Permanent',
        expirable: 'Expirable',
        removeRule: 'Remove',
      },
      cashback: {
        title: 'Cashback',
        description: 'Auto cashback when user consumption meets threshold.',
        enabled: 'Enable Cashback',
        enabledHint: 'When enabled, users meeting the threshold will receive cashback rewards.',
        threshold: 'Consumption Threshold',
        thresholdHint: 'Minimum consumption to trigger cashback.',
        mode: 'Cashback Mode',
        modeHint: 'Choose how the cashback amount is calculated.',
        modeFixed: 'Fixed Amount',
        modePercent: 'Percentage',
        modeRandom: 'Random Amount',
        fixedAmount: 'Fixed Amount',
        ...
        percentHint: 'Cashback as percentage of consumption.',
        randomMin: 'Min',
        randomMax: 'Max',
        randomHint: 'Random amount between min~max.',
        ...
        cycleHint: 'Choose when cashback is triggered.',
        cycleRealtime: 'Realtime (immediate per consumption)',
        cycleDaily: 'Daily (settled next day)',
      },
      offPeakPricing: {
        title: 'Time-based Pricing',
        description: 'Configure off-peak rate discounts, similar to energy time-of-use pricing.',
        enabled: 'Enable Time-based Pricing',
        enabledHint: 'When enabled, requests matching time rules will be billed at discounted rates.',
        rules: 'Time Rules',
        rulesHint: 'Configure rate multipliers by time period. Supports overnight spans (e.g. 22:00~07:00). Multiplier < 1 = discount, > 1 = surcharge.',
        addRule: 'Add Rule',
