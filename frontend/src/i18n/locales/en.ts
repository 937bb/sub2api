export default {
  ...
  nav: {
    ...
    balanceEntries: 'Balance History',
  ...
  balanceEntries: {
    ...
    description: 'View your balance changes and composition',
    summary: {
      totalBalance: 'Total Balance',
      permanentBalance: 'Permanent',
      expirableBalance: 'Expirable',
  ...
  checkin: {
    ...
    fixedMode: 'Daily Fixed',
    randomMode: 'Daily Random',
    milestones: 'Milestone Rewards',
    milestoneDays: '{days} consecutive days',
    balanceType: {
      permanent: 'Permanent',
      expirable: 'Expirable',
    },
    expiryDays: 'valid for {days} days',
  },
  ...
  admin: {
    ...
    users: {
      ...
      tabRedeemHistory: 'Redeem / Recharge',
      tabBalanceEntries: 'Balance Entries (incl. Rewards)',
      noBalanceEntries: 'No balance entries found',
      entryPermanent: 'Permanent',
      entryExpirable: 'Expirable',
      entryExpired: 'Expired',
      entryRemaining: 'Remaining',
      entryExpiresAt: 'Expires',
      sourceRecharge: 'Online Recharge',
      sourceRedeem: 'Redeem Code',
      sourceCheckin: 'Daily Check-in',
      sourceLeaderboard: 'Leaderboard Reward',
      sourceAdmin: 'Admin Adjustment',
      sourcePromo: 'Promo Code',
      sourceAffiliate: 'Affiliate Rebate',
      sourceFirstRedeemBonus: 'First Redeem Bonus',
      sourceRedeemBonus: 'Redeem Bonus',
      sourceCashback: 'Cashback',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          redeemRebate: 'Redeem Code Rebate',
          redeemRebateHint: 'When enabled, balance top-ups via redeem codes also trigger affiliate rebates (shares the same rate and rules as payment rebates).',
          customUsers: {
        ...
        firstRedeemBonus: {
          ...
          description: 'Extra bonus for first-time balance redeem code usage.',
          enabled: 'Enable First Redeem Bonus',
          enabledHint: 'When enabled, users get an extra bonus on their first balance redeem.',
          multiplier: 'Multiplier',
          multiplierHint: 'Multiplier of 2 means double (extra 1x). Redeem 10 → bonus 10.',
          cap: 'Bonus Cap',
          capHint: 'Maximum bonus amount. 0 = no cap.',
          balanceType: 'Bonus Balance Type',
          permanent: 'Permanent',
          expirable: 'Expirable',
          expiryDays: 'Expiry Days',
          expiryDaysHint: 'Only applies to expirable balance.',
        },
        redeemBonus: {
          title: 'Regular Redeem Bonus',
          description: 'Extra bonus on every balance redeem (including first, stacks with first redeem bonus).',
          enabled: 'Enable Regular Redeem Bonus',
          enabledHint: 'When enabled, every balance redeem triggers a bonus.',
          mode: 'Bonus Mode',
          modeHint: 'Choose how the bonus amount is calculated.',
          modeFixed: 'Fixed Amount',
          modePercent: 'Percentage',
          modeRandom: 'Random Amount',
          fixedAmount: 'Fixed Amount',
          fixedAmountHint: 'Fixed bonus per redeem.',
          percent: 'Bonus Percentage (%)',
          percentHint: 'Bonus as percentage of redeem amount.',
          randomMin: 'Min',
          randomMax: 'Max',
          randomHint: 'Random amount between min and max (supports 2 decimals, e.g. 0.01~1.00).',
          cap: 'Bonus Cap',
          capHint: 'Maximum bonus amount. 0 = no cap.',
          minAmount: 'Min Trigger Amount',
          minAmountHint: 'Redeem below this amount will not trigger bonus. 0 = no threshold.',
          balanceType: 'Bonus Balance Type',
          permanent: 'Permanent',
          expirable: 'Expirable',
          expiryDays: 'Expiry Days',
        ...
        checkin: {
          title: 'Daily Check-in',
          description: 'Configure daily check-in reward amounts, random ranges and milestone rules.',
          enabled: 'Enable Check-in',
          enabledHint: 'When enabled, users can check in daily to earn rewards.',
          mode: 'Reward Mode',
          modeHint: 'Choose how the base reward is calculated.',
          modeFixed: 'Fixed Amount',
          modeRandom: 'Random Amount',
          fixedAmount: 'Fixed Amount',
          fixedAmountHint: 'Fixed amount awarded per check-in.',
          randomMin: 'Min',
          randomMax: 'Max',
          randomHint: 'Random amount between min and max per check-in (supports 2 decimals, e.g. 0.01~1.00)',
          balanceType: 'Reward Balance Type',
          balanceTypeHint: 'Balance type for the base check-in reward.',
          permanent: 'Permanent',
          expirable: 'Expirable',
          expiryDays: 'Expiry Days',
          expiryDaysHint: 'Number of days the reward balance is valid (only for expirable type).',
          milestones: 'Milestone Rules',
          milestonesHint: 'One-time bonus for reaching N consecutive check-in days.',
          milestoneDays: 'Days',
          milestoneAmount: 'Amount',
          milestoneBalanceType: 'Balance Type',
          milestoneExpiryDays: 'Expiry (days)',
          addMilestone: 'Add Rule',
          removeMilestone: 'Remove',
        },
        balanceModel: {
          title: 'Balance Model',
          description: 'Configure balance expiry, deduction priority and advanced balance management.',
          expiryEnabled: 'Enable Balance Expiry',
          expiryEnabledHint: 'When enabled, expirable balance entries will be automatically cleared upon expiration. When disabled, all balances never expire.',
          warningDays: 'Expiry Warning Days',
          warningDaysHint: 'Number of days before expiry to show "expiring soon" on user dashboard (1-90).',
          deductionOrder: 'Deduction Priority',
          deductionOrderHint: 'Priority order when deducting balance for API consumption.',
          expiringFirst: 'Expiring balance first',
          permanentFirst: 'Permanent balance first',
        },
        leaderboard: {
          title: 'Leaderboard + Rewards',
          description: 'Configure spending leaderboard display and automatic daily rewards.',
          enabled: 'Enable Leaderboard',
          enabledHint: 'When enabled, users can view spending rankings and daily rewards are distributed.',
          maskEmail: 'Mask Email',
          maskEmailHint: 'When enabled, only partial email is shown to protect privacy.',
          topN: 'Show Top N',
          topNHint: 'Number of top users displayed on the leaderboard.',
          rewardRules: 'Reward Rules',
          rewardRulesHint: 'Configure rewards per rank. Supports fixed amount or percentage of yesterday spending.',
          addRule: 'Add Rule',
          ruleRank: 'Rank',
          ruleMode: 'Mode',
          ruleAmount: 'Amount/%',
          ruleBalanceType: 'Balance Type',
          ruleExpiryDays: 'Expiry Days',
          modeFixed: 'Fixed Amount',
          modePercent: 'Spending %',
          permanent: 'Permanent',
          expirable: 'Expirable',
          removeRule: 'Remove',
        },
        cashback: {
          title: 'Cashback',
          description: 'Auto-cashback to user balance when consumption meets threshold.',
          enabled: 'Enable Cashback',
          enabledHint: 'When enabled, users meeting the spending threshold receive cashback rewards.',
          threshold: 'Spending Threshold',
          thresholdHint: 'Minimum spending amount to trigger cashback.',
          mode: 'Cashback Mode',
          modeHint: 'Choose how cashback amount is calculated.',
          modeFixed: 'Fixed Amount',
          modePercent: 'Percentage',
          modeRandom: 'Random Amount',
          fixedAmount: 'Fixed Amount',
          fixedAmountHint: 'Fixed cashback per trigger.',
          percent: 'Cashback Rate (%)',
          percentHint: 'Cashback as percentage of spending.',
          randomMin: 'Min',
          randomMax: 'Max',
          randomHint: 'Random amount between min and max (supports 2 decimals, e.g. 0.01~1.00).',
          balanceType: 'Cashback Balance Type',
          permanent: 'Permanent',
          expirable: 'Expirable',
          expiryDays: 'Expiry Days',
          expiryDaysHint: 'Only applies to expirable balance.',
          cycle: 'Settlement Cycle',
          cycleHint: 'Choose when cashback is calculated.',
          cycleRealtime: 'Realtime (cashback per consumption)',
          cycleDaily: 'Daily (settled next day at midnight)',
        },
        offPeakPricing: {
          title: 'Time-of-Use Pricing',
          description: 'Configure off-peak rate discounts, similar to EV charging time-of-use pricing.',
          enabled: 'Enable Time-of-Use Pricing',
          enabledHint: 'When enabled, requests during configured time windows will be billed at a discounted rate.',
          rules: 'Time Window Rules',
          rulesHint: 'Configure rate multipliers by time window. Supports overnight spans (e.g. 22:00~07:00). Multiplier < 1 = discount, > 1 = surcharge.',
          addRule: 'Add Rule',
