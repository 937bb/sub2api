  ...
  admin: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        cchSigningHint: 'Sign the billing header in forwarded requests with CCH hash. Keep enabled for Claude OAuth mimic traffic; disabling preserves the placeholder for debugging only.',
