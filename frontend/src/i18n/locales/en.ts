    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          personalAccessTokenDesc: 'Enter a Codex Personal Access Token and the real ChatGPT Account ID. The account will be created as an OpenAI OAuth-like account using the step 1 settings.',
          ...
          personalAccessTokenAccountIdLabel: 'ChatGPT Account ID',
          personalAccessTokenAccountIdPlaceholder: 'Paste the real chatgpt_account_id...',
          personalAccessTokenAccountIdHint: 'Enter the real ChatGPT account/workspace ID. Quota/reset sends it upstream as chatgpt-account-id.',
          personalAccessTokenImportAndCreate: 'Create Account with PAT',
          personalAccessTokenEmpty: 'Please enter a Personal Access Token',
          personalAccessTokenAccountIdEmpty: 'Please enter a real ChatGPT Account ID',
