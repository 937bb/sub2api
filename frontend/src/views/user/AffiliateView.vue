      ...
      <template v-else-if="detail">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div class="card p-5">
            <div class="flex items-start justify-between">
              <span class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('affiliate.stats.rebateRate') }}</span>
              <div class="rounded-xl bg-primary-100 p-2 dark:bg-primary-900/30">
                <Icon name="dollar" size="md" class="text-primary-600 dark:text-primary-400" :stroke-width="2" />
              </div>
            </div>
            <p class="font-display mt-3 text-3xl font-bold tracking-tight text-primary-600 dark:text-primary-400">
              {{ formattedRebateRate }}<span class="ml-0.5 text-lg font-semibold">%</span>
            </p>
          ...
          <div class="card p-5">
            <div class="flex items-start justify-between">
              <span class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('affiliate.stats.invitedUsers') }}</span>
          ...
          <div class="card p-5">
            <div class="flex items-start justify-between">
              <span class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('affiliate.stats.availableQuota') }}</span>
            ...
            <p class="font-display mt-3 text-3xl font-bold tracking-tight text-emerald-600 dark:text-emerald-400">
              {{ formatCurrency(detail.aff_quota) }}
            </p>
          </div>
          <div class="card p-5">
            <div class="flex items-start justify-between">
              <span class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ t('affiliate.stats.totalQuota') }}</span>
            ...
            <p v-if="detail.aff_frozen_quota > 0" class="mt-2 text-xs text-amber-600 dark:text-amber-400">
        ...
        <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-5">
          ...
          <div class="space-y-6 lg:col-span-3">
            <div class="card p-6">
              <h3 class="text-base font-semibold text-gray-900 dark:text-white">{{ t('affiliate.yourCode') }}</h3>
