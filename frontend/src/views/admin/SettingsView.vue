      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-6 p-6">
            <div class="flex items-center justify-between">
              <div>
                <label class="input-label">{{ t('admin.settings.features.balanceModel.expiryEnabled') }}</label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.features.balanceModel.expiryEnabledHint') }}</p>
              </div>
              <Toggle v-model="form.balance_expiry_enabled" />
            </div>
            <div v-if="form.balance_expiry_enabled" class="space-y-6">
              <div>
                <label class="input-label">{{ t('admin.settings.features.balanceModel.warningDays') }}</label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.features.balanceModel.warningDaysHint') }}</p>
                <input v-model.number="form.balance_expiry_warning_days" type="number" min="1" max="90" class="input mt-2 w-32" />
              </div>
              <div>
                <label class="input-label">{{ t('admin.settings.features.balanceModel.deductionOrder') }}</label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ t('admin.settings.features.balanceModel.deductionOrderHint') }}</p>
...
const form = reactive<SettingsForm>({
  ...
  // Redeem Bonus (Regular)
  redeem_bonus_enabled: false,
  redeem_bonus_mode: "fixed",
  redeem_bonus_fixed_amount: "0",
  redeem_bonus_percent: "5",
...
async function saveSettings() {
  ...
  try {
    ...
    const settingString = (value: unknown): string => String(value ?? "").trim();
    ...
    const payload: UpdateSettingsRequest = {
      ...
      first_redeem_bonus_multiplier: settingString(
        form.first_redeem_bonus_multiplier,
      ),
      first_redeem_bonus_cap: settingString(form.first_redeem_bonus_cap),
      first_redeem_bonus_balance_type: form.first_redeem_bonus_balance_type,
      first_redeem_bonus_expiry_days: settingString(
        form.first_redeem_bonus_expiry_days,
      ),
      checkin_enabled: form.checkin_enabled,
      checkin_mode: form.checkin_mode,
      checkin_fixed_amount: settingString(form.checkin_fixed_amount),
      checkin_random_min: settingString(form.checkin_random_min),
      checkin_random_max: settingString(form.checkin_random_max),
      checkin_balance_type: form.checkin_balance_type,
      checkin_expiry_days: settingString(form.checkin_expiry_days),
      ...
      leaderboard_top_n: settingString(form.leaderboard_top_n),
      leaderboard_reward_rules: JSON.stringify(leaderboardRewardRules.value),
      cashback_enabled: form.cashback_enabled,
      cashback_threshold: settingString(form.cashback_threshold),
      cashback_mode: form.cashback_mode,
      cashback_fixed_amount: settingString(form.cashback_fixed_amount),
      cashback_percent: settingString(form.cashback_percent),
      cashback_random_min: settingString(form.cashback_random_min),
      cashback_random_max: settingString(form.cashback_random_max),
      cashback_balance_type: form.cashback_balance_type,
      cashback_expiry_days: settingString(form.cashback_expiry_days),
      cashback_cycle: form.cashback_cycle,
      ...
      redeem_bonus_mode: form.redeem_bonus_mode,
      redeem_bonus_fixed_amount: settingString(
        form.redeem_bonus_fixed_amount,
      ),
      redeem_bonus_percent: settingString(form.redeem_bonus_percent),
      redeem_bonus_random_min: settingString(form.redeem_bonus_random_min),
      redeem_bonus_random_max: settingString(form.redeem_bonus_random_max),
      redeem_bonus_cap: settingString(form.redeem_bonus_cap),
      redeem_bonus_min_amount: settingString(form.redeem_bonus_min_amount),
      redeem_bonus_balance_type: form.redeem_bonus_balance_type,
      redeem_bonus_expiry_days: settingString(form.redeem_bonus_expiry_days),
      // Balance Model
      balance_expiry_enabled: form.balance_expiry_enabled,
      balance_expiry_warning_days: form.balance_expiry_warning_days,
      balance_deduction_order: form.balance_deduction_order,
...
// ==================== Reward System: Checkin Milestones ====================
