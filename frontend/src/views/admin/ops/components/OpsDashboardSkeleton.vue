...
<template>
  <div class="space-y-6">
    ...
    <div :class="['rounded-3xl bg-[var(--glass-bg-content)] border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div class="rounded-2xl border border-gray-200 bg-white/40 p-4 dark:border-white/10 dark:bg-white/[0.03]/30 lg:col-span-5">
        ...
        <div class="lg:col-span-7">
          <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="i in 6" :key="i" class="h-20 animate-pulse rounded-2xl border border-gray-200 bg-white/40 dark:border-white/10 dark:bg-white/[0.03]/30"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
      <div :class="['min-h-[360px] rounded-3xl bg-[var(--glass-bg-content)] border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10 lg:col-span-1', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div :class="['min-h-[360px] rounded-3xl bg-[var(--glass-bg-content)] border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10 lg:col-span-2', props.fullscreen ? 'p-8' : 'p-6']">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
      <div
        v-for="i in 3"
        :key="i"
        :class="['rounded-3xl bg-[var(--glass-bg-content)] border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10', props.fullscreen ? 'p-8' : 'p-6']"
      >
        <div class="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-dark-700"></div>
    ...
    <div :class="['rounded-3xl bg-[var(--glass-bg-content)] border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10', props.fullscreen ? 'p-8' : 'p-6']">
      ...
      <div class="mt-6 space-y-3">
        <div v-for="i in 6" :key="i" class="flex items-center justify-between gap-4 rounded-2xl border border-gray-200 bg-white/40 p-4 dark:border-white/10 dark:bg-white/[0.03]/30">
