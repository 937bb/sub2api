...
function statusBadgeClass(status: string | undefined): string {
  ...
  if (s === 'manual_resolved') return 'bg-zinc-50 text-zinc-700 ring-zinc-600/20 dark:bg-zinc-900/30 dark:text-zinc-300 dark:ring-zinc-500/30'
...
<template>
  <div class="rounded-3xl bg-[var(--glass-bg-content)] p-6 border border-gray-200/70 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.15)] dark:border-white/10">
    ...
    >
      ...
      <div v-else class="space-y-5">
        <div class="rounded-xl border border-gray-200 bg-white/40 p-4 dark:border-white/10 dark:bg-white/[0.03]">
          <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
              <div class="flex items-center gap-2 rounded-lg bg-[var(--glass-bg-content)] px-2 py-1 ring-1 ring-gray-200  dark:ring-dark-700">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-xl border border-gray-200 bg-white/40 p-4 dark:border-white/10 dark:bg-white/[0.03]">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-2">
                ...
                <a
                  class="inline-flex items-center gap-1 rounded-md bg-[var(--glass-bg-content)] px-2 py-1 text-[11px] font-bold text-gray-700 ring-1 ring-gray-200 hover:bg-gray-50  dark:text-gray-200 dark:ring-dark-700 dark:hover:bg-dark-700"
        ...
        <div class="rounded-xl border border-gray-200 bg-[var(--glass-bg-content)] p-4 dark:border-dark-700 ">
