      ...
      <div class="rounded-2xl border border-gray-200 dark:border-white/10 bg-white/40 p-4 dark:bg-dark-700/50">
        ...
        <div v-if="draftAlert.silencing.enabled" class="mt-4 space-y-4">
          ...
          <div class="rounded-xl border border-gray-200 bg-[var(--glass-bg-content)] p-4 dark:border-dark-700 ">
            ...
            <div v-if="!draftAlert.silencing.entries?.length" class="mt-3 rounded-lg border border-gray-200 dark:border-white/10 bg-white/40 p-3 text-xs text-gray-500 dark:bg-dark-900 dark:text-gray-400">
