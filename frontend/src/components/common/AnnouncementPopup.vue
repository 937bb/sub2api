<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-[var(--glass-bg-overlay)] backdrop-blur-2xl border border-[var(--glass-border)] shadow-2xl"
          @click.stop
        >
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-transparent px-8 py-8">
            <div class="relative">
          ...
          <!-- Footer -->
          <div class="border-t border-gray-100 bg-white/5 px-8 py-5 dark:border-dark-700">
