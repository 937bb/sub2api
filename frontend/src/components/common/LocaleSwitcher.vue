<template>
  <div class="relative" ref="dropdownRef">
    ...
    <transition name="dropdown">
      <div
        v-if="isOpen"
        class="absolute right-0 z-50 mt-1 w-32 overflow-hidden rounded-lg border border-gray-200 bg-[var(--glass-bg-dropdown)] backdrop-blur-xl shadow-lg dark:border-dark-700 "
      >
        <button
