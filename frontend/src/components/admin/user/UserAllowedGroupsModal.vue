  ...
  <BaseDialog :show="show" :title="t('admin.users.groupConfig')" width="wide" @close="$emit('close')">
    <div v-if="user" class="space-y-6">
      ...
      <div class="flex items-center gap-4 rounded-2xl bg-gradient-to-r from-primary-50 to-primary-100 p-5 dark:from-primary-900/30 dark:to-primary-800/20">
        <div class="flex h-14 w-14 items-center justify-center rounded-full bg-[var(--glass-bg-content)] shadow-sm ">
          ...
          <div class="grid gap-3">
            <div
              ...
              :class="config.isSelected
                ...
                : 'border-gray-200 bg-[var(--glass-bg-content)] hover:border-gray-300 dark:border-dark-600  dark:hover:border-dark-500'"
            >
              <div class="flex items-center gap-4">
                ...
                <div class="flex flex-shrink-0 items-center gap-3">
                  ...
                  <input
                    ...
                    class="hide-spinner w-24 rounded-lg border border-gray-300 bg-[var(--glass-bg-content)] px-3 py-2 text-sm font-medium transition-colors focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-dark-500  dark:focus:border-primary-500"
                  />
                </div>
              </div>
            </div>
