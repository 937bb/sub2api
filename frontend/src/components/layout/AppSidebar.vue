...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/models', label: t('nav.modelMarketplace'), icon: PriceTagIcon, hideInSimpleMode: true, featureFlag: flagAvailableChannels },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/time-billing', label: t('nav.timeBilling'), icon: PriceTagIcon },
    {
      path: '/admin/channels',
    ...
    { path: '/admin/growth', label: t('nav.growth'), icon: GiftIcon, hideInSimpleMode: true },
