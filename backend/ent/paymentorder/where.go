...
// FulfillmentLeaseTokenIsNil applies the IsNil predicate on the "fulfillment_lease_token" field.
func FulfillmentLeaseTokenIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldFulfillmentLeaseToken))
}

// FulfillmentLeaseTokenNotNil applies the NotNil predicate on the "fulfillment_lease_token" field.
func FulfillmentLeaseTokenNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldFulfillmentLeaseToken))
}
