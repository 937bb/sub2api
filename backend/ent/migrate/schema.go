...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "openai_model_mapping_enabled", Type: field.TypeBool, Default: false},
		{Name: "openai_model_mapping", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "openai_transient_error_retry_enabled", Type: field.TypeBool, Default: false},
		{Name: "openai_transient_error_retry_count", Type: field.TypeInt, Default: 3},
		...
		{Name: "quota_bypass_enabled", Type: field.TypeBool, Default: false},
		{Name: "quota_bypass_concentrated_scheduling_enabled", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "quota_bypass_applied", Type: field.TypeBool, Default: false},
		{Name: "quota_bypass_inject_pairs", Type: field.TypeInt, Default: 0},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
