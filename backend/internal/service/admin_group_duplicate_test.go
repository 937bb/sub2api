...
func TestDuplicateGroupCopiesConfigurationDeeplyAndResetsRuntimeState(t *testing.T) {
	...
	require.Equal(t, source.QuotaBypassEnabled, duplicate.QuotaBypassEnabled)
	require.Equal(t, source.QuotaBypassConcentratedSchedulingEnabled, duplicate.QuotaBypassConcentratedSchedulingEnabled)
