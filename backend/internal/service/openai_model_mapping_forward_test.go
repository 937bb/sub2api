...
func TestOpenAIGatewayServiceForwardOAuthPreservesExplicitMappingTarget(t *testing.T) {
	...
	upstream := &httpUpstreamRecorder{
		resp: &http.Response{
			...
			Body: io.NopCloser(strings.NewReader(
				"data: {\"type\":\"response.completed\",\"response\":{\"id\":\"resp_mapping\",\"model\":\"gpt-5.6-sol-wm\",\"usage\":{\"input_tokens\":1,\"output_tokens\":2}}}\n\n" +
					"data: [DONE]\n\n",
			)),
		},
	}
	...
	account := &Account{
		ID:          937,
		Name:        "openai-oauth-explicit-model-mapping",
