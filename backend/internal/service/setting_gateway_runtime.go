...
// DefaultOpenAICodexUserAgent is the official codex-rs default-client UA.
// Its version segment is rebuilt whenever codexCLIVersion changes.
...
// 未填面板 UA 时按当前生效的客户端版本号拼出标准 codex-rs CLI UA。
//
