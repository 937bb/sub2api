...
const (
	...
	// SettingKeyOpenAIOAuth429DynamicSettings stores JSON config for OpenAI OAuth-like 429 sampling.
	...
	// SettingKeyOpenAIOAuthWSDefaultEnabled controls the inherited WSv2 default for
	// OpenAI OAuth-like subscription accounts. Account-level mode remains authoritative.
	SettingKeyOpenAIOAuthWSDefaultEnabled = "openai_oauth_ws_default_enabled"
	// SettingKeyOpenAICodexFingerprintDefaultFullEnabled controls the inherited
	// Codex fingerprint mode when an OAuth-like account has no explicit mode.
	SettingKeyOpenAICodexFingerprintDefaultFullEnabled = "openai_codex_fingerprint_default_full_enabled"
