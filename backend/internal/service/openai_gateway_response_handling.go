...
func (s *OpenAIGatewayService) handleNonStreamingResponse(ctx context.Context, resp *http.Response, c *gin.Context, account *Account, originalModel, mappedModel string) (*openaiNonStreamingResult, error) {
	...
	if isEventStreamResponse(resp.Header) {
		return s.handleSSEToJSONForAccount(resp, c, account, body, originalModel, mappedModel)
	}
...
func (s *OpenAIGatewayService) handleSSEToJSON(resp *http.Response, c *gin.Context, body []byte, originalModel, mappedModel string) (*openaiNonStreamingResult, error) {
	return s.handleSSEToJSONForAccount(resp, c, nil, body, originalModel, mappedModel)
}

func (s *OpenAIGatewayService) handleSSEToJSONForAccount(resp *http.Response, c *gin.Context, account *Account, body []byte, originalModel, mappedModel string) (*openaiNonStreamingResult, error) {
