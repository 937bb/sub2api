...
const apiKeyAuthSnapshotVersion = 21 // v21: combine time billing, long-context, and model pricing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			TimeBillingRules:                append([]TimeBillingRule(nil), apiKey.Group.TimeBillingRules...),
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			TimeBillingRules:                append([]TimeBillingRule(nil), snapshot.Group.TimeBillingRules...),
