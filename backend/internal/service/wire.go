...
func ProvideSettingService(settingRepo SettingRepository, groupRepo GroupRepository, proxyRepo ProxyRepository, cfg *config.Config) *SettingService {
	...
	SetCodexConfiguredUserAgentResolver(func() string {
		return svc.GetOpenAICodexUserAgentOverride(context.Background())
	})
	return svc
}
...
func ProvideAntiDegradeService(admin AntiDegradeStore, cfg *config.Config, plugins *PluginManager) *AntiDegradeService {
