...
func (s *OpenAIGatewayService) markOpenAIOAuth429RateLimited(ctx context.Context, account *Account, headers http.Header, responseBody []byte) {
	...
	if disposition == openAIOAuth429Transient && !IsAccountQuotaBypassEligible(account) &&
		((s.rateLimitService != nil && s.rateLimitService.IsOpenAIOAuth429DynamicEnabled(ctx, account)) ||
