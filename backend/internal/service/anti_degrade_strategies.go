...
var antiDegradeStrategyProfiles = []AntiDegradeStrategyProfile{
	...
	{ID: AntiDegradeMode1, Name: "Codex 保护 v3", Description: "账号级设备身份、独立会话、标准传输和请求语义完整性。", Category: "常用", IdentityMode: "device", TLSProfile: "standard", MaxConcurrency: 16, Risk: "低", ApplySupported: true, RequiresOpenAI: true},
