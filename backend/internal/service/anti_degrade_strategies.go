...
var antiDegradeStrategyProfiles = []AntiDegradeStrategyProfile{
	...
	{ID: AntiDegradeModeLegacy, Name: "初代兼容", Description: "复用旧版 session 身份和 Node.js 24 传输，仅用于手动兼容性对照。", Category: "诊断", IdentityMode: "session", TLSProfile: "nodejs24", MaxConcurrency: 16, Risk: "中", ApplySupported: true, DiagnosticOnly: true},
	{ID: AntiDegradeMode1, Name: "Codex 保护 v3", Description: "账号级设备身份、独立会话、标准传输和观察式请求语义校验。", Category: "常用", IdentityMode: "device", TLSProfile: "standard", MaxConcurrency: 16, Risk: "低", ApplySupported: true, RequiresOpenAI: true},
