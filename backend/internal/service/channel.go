...
type Channel struct {
	...
	Description        string
	Status             string
	BillingModelSource string         // "requested", "upstream", "channel_mapped", "group_mapped", or "response_model"
...
type ChannelUsageFields struct {
	...
	BillingModelSource string // 计费模型来源："requested" / "upstream" / "channel_mapped" / "group_mapped"
