...
func (s *AccountTestService) TestAccountConnectionReadOnly(c *gin.Context, accountID int64, modelID string, prompt string, mode string, opts ...AccountTestOptions) error {
...
func (s *AccountTestService) testOpenAIAccountConnection(c *gin.Context, account *Account, modelID string, prompt string, mode string) error {
	...
	if isOAuth {
		...
		enforceCodexIdentityHeadersWithUA(req.Header, codexAccountUserAgent(credentialAccount))
		applyCodexClientEnvironmentHeaders(req.Header, credentialAccount)
	}
