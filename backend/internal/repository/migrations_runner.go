...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	// 192 was historically applied with the shorter Team-only comment. The
	// schema operation is identical; accept that recorded checksum while keeping
	// the current migration content immutable for new installations.
	"192_group_quota_bypass_enabled.sql":                      newMigrationChecksumCompatibilityRule("89d50e374a8b1fd23e61b012bac82d98bdc277072b56e361a40b7dcb3171fc8b", "63552d7e82dfb6bbf927afef97f91441ca2f40c87b9e3dffc5c2a2d72796c11b"),
