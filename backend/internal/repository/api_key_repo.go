	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldOpenaiModelMappingEnabled,
				group.FieldOpenaiModelMapping,
				group.FieldOpenaiTransientErrorRetryEnabled,
				group.FieldOpenaiTransientErrorRetryCount,
				...
				group.FieldQuotaBypassConcentratedSchedulingEnabled,
