...
func TestOpenAIGatewayHandlerResponses_ReleasesImageSlotWhenUserSlotDenied(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	h := &OpenAIGatewayHandler{
		...
		concurrencyHelper: &ConcurrencyHelper{concurrencyService: service.NewConcurrencyService(
			&helperConcurrencyCacheStub{userSeq: []bool{false}},
		)},
...
func TestOpenAIGatewayHandlerImages_ReleasesImageSlotWhenUserSlotDenied(t *testing.T) {
	gin.SetMode(gin.TestMode)
