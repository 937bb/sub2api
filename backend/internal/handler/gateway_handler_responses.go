...
func (h *GatewayHandler) handleResponsesFailoverExhausted(c *gin.Context, lastErr *service.UpstreamFailoverError, streamStarted bool) {
	...
	if streamStarted {
		...
		// In that case a terminal frame is still required. Preserve an official
		// terminal failure that was already marked, but terminate partial output
		// instead of leaving strict Responses clients with a silent EOF.
