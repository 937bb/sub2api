...
func provideCleanup(
	...
	return func() {
		...
		// Run application cleanup in parallel, then close Redis and Ent sequentially.
		parallelSteps := []cleanupStep{
			{"GrowthSettlementService", func() error {
				if growthSettlement != nil {
					growthSettlement.Stop()
				}
				return nil
			}},
