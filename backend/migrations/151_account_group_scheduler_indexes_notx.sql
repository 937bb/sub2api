-- Account scheduler orders group bindings by group/priority, and account loading
-- batches bindings by account/priority; create concurrently for live installs.
