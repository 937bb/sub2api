...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/is7Qin/sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/is7Qin/sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/is7Qin/sub2api/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/is7Qin/sub2api/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
